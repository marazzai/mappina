...
export default function LoginPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    else router.push("/dashboard/crea");
  }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <form onSubmit={handleLogin} className="bg-white p-8 rounded-xl shadow w-full max-w-sm flex flex-col gap-4">
        ...
        <button type="submit" className="btn bg-brand text-white hover:bg-brand-dark">Accedi</button>
        ...
        <a href="/register" className="text-sm text-brand hover:underline text-center">Non hai un account? Registrati</a>
      </form>
    </div>
  );
}
